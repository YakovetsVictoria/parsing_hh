...
8.	Импортировать в Power BI из базы данных таблицы `vacancy_company_info` и `skill`, связать их по id вакансий. При желании добавить облако слов, построить необходимые графики.
